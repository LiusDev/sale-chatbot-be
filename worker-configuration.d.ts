/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 6f481a2ad8db12cd030da7dc08b4fc18)
...
declare namespace Cloudflare {
	interface Env {
		...
		META_VERIFY_SIGNATURE: string;
		sale_chatbot_r2: R2Bucket;
		sale_chatbot: D1Database;
